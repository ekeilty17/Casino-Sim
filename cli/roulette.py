...
from casino.roulette.bootstrap import SimulationBootstrapper


def parse_args() -> argparse.Namespace:
    """Parse command-line arguments."""
    parser = argparse.ArgumentParser(description="Run Roulette simulation.")
    parser.add_argument(
        "config_path",
...
def main():
    """Main entry point for the roulette simulation CLI."""
    args = parse_args()
