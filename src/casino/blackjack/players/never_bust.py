...
from blackjack.action import BlackJackAction
...
class NeverBustPlayer(Player):
    ...
    def action(self, hand, dealer_upcard, allowed_actions):
        ...
        if basic_strategy_action in [BlackJackAction.SPLIT, BlackJackAction.DOUBLE]:
        ...
        return BlackJackAction.STAND if total > 11 else BlackJackAction.HIT